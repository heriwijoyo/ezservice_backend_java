 ...
 */
public class EzCoreOrgConfigConverter extends CommonDOModelConverter<DAOCoreOrgConfigDO, CoreConfig> {

    @Override
    protected CoreConfig safeConvertQuery(DAOCoreOrgConfigDO dataObject) {
    ...
    @Override
    protected DAOCoreOrgConfigDO safeConvertStore(CoreConfig model) {
        DAOCoreOrgConfigDO configDO = new DAOCoreOrgConfigDO();
