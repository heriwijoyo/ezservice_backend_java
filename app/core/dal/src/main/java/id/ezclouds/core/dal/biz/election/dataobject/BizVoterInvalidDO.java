 ...
 * @version $Id: BizVoterInvalidDO.java, v 0.1 2024‐10‐06 10:18 AM Heri Wijoyo (heri.wijoyo@gmail.com) Exp $$
 */
@Entity
@Table(name = "biz_election_voter_invalid")
public class BizVoterInvalidDO {
