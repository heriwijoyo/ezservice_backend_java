 ...
 * @version $Id: BizVoterInvalidConverter.java, v 0.1 2024‐10‐06 10:20 AM Heri Wijoyo (heri.wijoyo@gmail.com) Exp $$
 */
public class BizVoterInvalidConverter extends CommonDOModelConverter<BizVoterInvalidDO, BizVoterInvalid> {

    @Override
    protected BizVoterInvalid safeConvertQuery(BizVoterInvalidDO dataObject) {
        BizVoterInvalid bizVoter = new BizVoterInvalid();
        ...
        bizVoter.setInvalidCode(dataObject.getInvalidCode());
        bizVoter.setInvalidMessage(dataObject.getInvalidMessage());
    ...
    @Override
    protected BizVoterInvalidDO safeConvertStore(BizVoterInvalid model) {
        BizVoterInvalidDO voterDO = new BizVoterInvalidDO();
        ...
        voterDO.setInvalidCode(model.getInvalidCode());
        voterDO.setInvalidMessage(model.getInvalidMessage());
