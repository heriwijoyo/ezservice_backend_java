...
public enum ApiEvent implements EzAppEvent {
    ...
    API_NEWS("API_NEWS"),
    API_NEWS_DETAIL("API_NEWS_DETAIL"),
    API_APP_EVENT("API_APP_EVENT"),
    API_MESSAGE_MEMBER("API_MESSAGE_MEMBER"),
    API_MESSAGE_MEMBER_DETAIL("API_MESSAGE_MEMBER_DETAIL"),
    ...
    // PageResult APIs
    API_PAGE_SUB_ORGANIZATIONS("API_GET_SUB_ORGANIZATIONS"),
    API_PAGE_MEMBER("API_GET_MEMBER"),
    API_PAGE_APP_DOCUMENTS("API_GET_APP_DOCUMENTS"),
    ...
    API_ASYNC_PROCESS_TRIGGER("API_ASYNC_PROCESS_TRIGGER"),
    ...
    API_ADMIN_MEMBER_UPDATE("API_ADMIN_MEMBER_UPDATE"),
    ;
