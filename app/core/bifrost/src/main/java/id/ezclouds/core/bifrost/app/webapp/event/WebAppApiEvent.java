...
public enum WebAppApiEvent implements EzAppEvent {
    ...
    WEBAPP_API_INIT_SYSTEM_SEQUENCE("WEBAPP_API_INIT_SYSTEM_SEQUENCE"),
    WEBAPP_API_INIT_MIGRATE_MEMBER("WEBAPP_API_INIT_MIGRATE_MEMBER"),

    WEBAPP_API_ORGANIZATIONS("WEBAPP_API_ORGANIZATIONS"),
    WEBAPP_API_ADMIN_PARAM_CONFIG("WEBAPP_API_ADMIN_PARAM_CONFIG"),
    WEBAPP_API_TRIGGER_ASYNC_PROCESS("WEBAPP_API_TRIGGER_ASYNC_PROCESS"),
