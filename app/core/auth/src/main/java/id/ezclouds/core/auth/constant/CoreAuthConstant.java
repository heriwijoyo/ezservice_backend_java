 ...
 */
package id.ezclouds.core.auth.constant;

/**
 * @author Heri Wijoyo (heri.wijoyo@gmail.com)
 * @version $Id: CoreAuthConstant.java, v 0.1 2024‐01‐28 7:01 PM Heri Wijoyo (heri.wijoyo@gmail.com) Exp $$
 */
public class CoreAuthConstant {

    public static final String DEFAULT_LOGIN_TYPE = "PHONE";
