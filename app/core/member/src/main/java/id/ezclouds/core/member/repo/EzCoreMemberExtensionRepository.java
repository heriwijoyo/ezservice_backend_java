 ...
 * @version $Id: EzCoreMemberExtensionRepository.java, v 0.1 2023‐12‐31 11:58 AM Heri Wijoyo (heri.wijoyo@gmail.com) Exp $$
 */
@Repository
public interface EzCoreMemberExtensionRepository extends JpaRepository<EzCoreMemberExtensionDO, String> {
