 ...
 */
package id.ezclouds.biz.election.service.webbiz;

import id.ezclouds.biz.election.enums.ImageRestriction;
                ...
                if (request.getScene().getRestriction() == ImageRestriction.PRIVATE) {
                    ...
                    switch (request.getScene()) {
                        ...
                        case PUBLIC_VIDEO_CARD_GALLERY:
                            ...
                            break;
                        case PUBLIC_DOCUMENT_GALLERY:
                            imagePath = fileInfo.getDocsGalleryPath(request.getFileName());
                            break;
