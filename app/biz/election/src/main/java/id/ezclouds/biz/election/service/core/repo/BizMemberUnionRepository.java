...
import id.ezclouds.biz.election.service.core.dataobject.BizCustomQueryGroupDO;
...
public interface BizMemberUnionRepository extends JpaRepository<BizMemberUnionDO, String> {
    ...
    @Query("SELECT new id.ezclouds.biz.election.service.core.dataobject.BizCustomQueryGroupDO(bmu.source, COUNT(bmu.source)) "
    ...
    @Query("SELECT new id.ezclouds.biz.election.service.core.dataobject.BizCustomQueryGroupDO(bmu.role, COUNT(*)) "
    ...
    @Query("SELECT new id.ezclouds.biz.election.service.core.dataobject.BizCustomQueryGroupDO(bmu.gender, COUNT(*)) "
    ...
    @Query("SELECT new id.ezclouds.biz.election.service.core.dataobject.BizCustomQueryGroupDO(bmu.tpsNumber, COUNT(*)) "
    ...
    @Query("SELECT new id.ezclouds.biz.election.service.core.dataobject.BizCustomQueryGroupDO(bmu.subOrgName, COUNT(bmu.subOrgName)) "
    ...
    @Query("SELECT new id.ezclouds.biz.election.service.core.dataobject.BizCustomQueryGroupDO(bmu.subOrgId, COUNT(bmu.subOrgId)) "
    ...
    @Query("SELECT new id.ezclouds.biz.election.service.core.dataobject.BizCustomQueryGroupDO(bmu.districtName, COUNT(*)) "
    ...
    @Query("SELECT new id.ezclouds.biz.election.service.core.dataobject.BizCustomQueryGroupDO(bmu.tpsNumber, COUNT(bmu.tpsNumber)) "
            + "FROM BizMemberUnionDO AS bmu WHERE bmu.orgId = ?1 AND bmu.source = ?2 AND bmu.districtName = ?3 AND bmu.villageName = ?4 GROUP BY bmu.tpsNumber")
