 ...
 */
package id.ezclouds.biz.election.service.async.processor;
...
import id.ezclouds.biz.election.enums.BizAsyncScene;
import id.ezclouds.biz.election.service.async.parser.SyncMemberConverter;
import id.ezclouds.biz.election.service.core.dataobject.BizMemberImportDO;
import id.ezclouds.biz.election.service.core.dataobject.BizMemberImportFailedDO;
import id.ezclouds.biz.election.service.core.repo.BizMemberImportFailedRepository;
import id.ezclouds.biz.election.service.core.repo.BizMemberImportRepository;
import id.ezclouds.biz.election.service.request.BizAsyncProcessRequest;
 ...
 * @version $Id: BizOldSyncBatchMemberProcessor.java, v 0.1 2024‐07‐11 4:41 AM Heri Wijoyo (heri.wijoyo@gmail.com) Exp $$
 */
@Service
public class BizOldSyncBatchMemberProcessor implements BizOldAsyncProcessor {
