...
public interface BizMemberUnionRepository extends JpaRepository<BizMemberUnionDO, String> {
    ...
    @Query("SELECT new id.ezclouds.admin.ezservice.service.core.dataobject.BizCustomQueryGroupDO(bmu.source, COUNT(bmu.source)) "
    ...
    @Query("SELECT new id.ezclouds.admin.ezservice.service.core.dataobject.BizCustomQueryGroupDO(bmu.role, COUNT(*)) "
    ...
    @Query("SELECT new id.ezclouds.admin.ezservice.service.core.dataobject.BizCustomQueryGroupDO(bmu.role, COUNT(bmu.role)) "
    ...
    @Query("SELECT new id.ezclouds.admin.ezservice.service.core.dataobject.BizCustomQueryGroupDO(bmu.gender, COUNT(bmu.gender)) "
    ...
    @Query("SELECT new id.ezclouds.admin.ezservice.service.core.dataobject.BizCustomQueryGroupDO(bmu.tpsNumber, COUNT(bmu.tpsNumber)) "
    ...
    @Query("SELECT new id.ezclouds.admin.ezservice.service.core.dataobject.BizCustomQueryGroupDO(bmu.subOrgName, COUNT(bmu.subOrgName)) "
    ...
    @Query("SELECT new id.ezclouds.admin.ezservice.service.core.dataobject.BizCustomQueryGroupDO(bmu.subOrgId, COUNT(bmu.subOrgId)) "
    ...
    @Query("SELECT new id.ezclouds.admin.ezservice.service.core.dataobject.BizCustomQueryGroupDO(bmu.districtName, COUNT(bmu.districtName)) "
