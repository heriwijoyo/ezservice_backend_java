 ...
 * @version $Id: BizCacheKey.java, v 0.1 2024‐04‐09 2:03 AM Heri Wijoyo (heri.wijoyo@gmail.com) Exp $$
 */
public final class BizCacheKey {

    public static final String ORGANIZATION_ALL         = "ORGANIZATION_ALL";
    public static final String SUB_ORGANIZATION_ALL     = "SUB_ORGANIZATION_ALL";
    ...
    public static final String WEBAPP_MASTER_DATA           = "WEBAPP_MASTER_DATA";
    public static final String WEBAPP_MASTER_DATA_OVERALL   = "WEBAPP_MASTER_DATA_OVERALL";
